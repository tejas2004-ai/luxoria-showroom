        ...
        >
          {items.map((item) => (
            <motion.li
              ...
              className="group relative flex shrink-0 cursor-pointer flex-col items-center rounded-3xl border border-white/10 bg-card/60 backdrop-blur-2xl p-6 transition-all duration-500 hover:border-accent/60 hover:bg-card/90 hover:shadow-[0_25px_60px_-15px_rgba(155,113,178,0.35)] w-[300px] md:w-[380px]"
